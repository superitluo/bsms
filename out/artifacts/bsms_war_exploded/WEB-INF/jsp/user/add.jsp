...
<head>
    ...
    <script src="../common/bsms/js/user/add.js"></script>
    <title>添加用户</title>
    <style>
        .addform {
            padding: 50px;
    ...
    <div class="addform">
        ...
        <div class="layui-form-item" padding="10px">
            ...
            <div class="layui-input-block">
                <input type="text" name="usercode" lay-verify="required" lay-verType='tips' autocomplete="off"
        ...
        <div class="layui-form-item" padding="10px">
            ...
            <div class="layui-input-block">
                <input type="text" name="username" lay-verify="required" lay-verType='tips' autocomplete="off"
        ...
        <div class="layui-form-item" padding="10px">
            ...
            <div class="layui-input-block">
                <select name="userrole" id="userrole" lay-filter="userrole" lay-search="">
