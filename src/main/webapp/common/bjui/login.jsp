...
<div class="container">
    <div class="main_box">
        <form action="../../WEB-INF/index.html" id="login_form" method="post">
            <input type="hidden" value="" id="j_randomKey"/>
            <input type="hidden" name="jfinal_token" value=""/>
            <p class="text-center logo"><img src="images/logo33.png" height="45"></p>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" id="j_password" name="passwordhash" placeholder="登录密码"
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="j_captcha" name="captcha" placeholder="验证码"
                           aria-describedby="sizing-addon-password">
                    <span class="input-group-addon code" id="basic-addon-code"><img id="captcha_img"
                                                                                    src="images/captcha.jpg" alt="点击更换"
